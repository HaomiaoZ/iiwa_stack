...
# First point #
# wpose = PoseStamped()
# wpose.header.frame_id = reference_frame
# wpose.header.stamp = rospy.Time.now()
'''
wpose.position.x = -0.3
wpose.position.y = 0.463116
wpose.position.z = 0.84871
wpose.orientation.x = 1.8236e-5
wpose.orientation.y = -0.30307
wpose.orientation.z = -6.2059e-5
wpose.orientation.w = 0.952967
